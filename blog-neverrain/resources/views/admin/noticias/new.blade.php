...
@section('content')    
    <div class="container">
        ...
        <form action="/ademiro/noticias/store" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row form-group">
                ...
                <div class="col-md-4">
                    ...
                    <input type="hidden" name="tags" id="tgs" value="[]">
                </div>
            </div>
            <div class="row">
                        ...
                        <tbody>
                            @foreach ($langs as $lang)
                                <tr>
                                    ...
                                    <td><input type="text" name="titulo_{{$lang}}" class="form-control" id="titulo_{{$lang}}" required></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            @foreach ($langs as $lang)
                                <tr>
                                    ...
                                    <td><textarea name="corpo_{{$lang}}" class="form-control" id="corpo_{{$lang}}" cols="30" rows="10" required></textarea></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
